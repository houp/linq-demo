...
namespace boring.bank.dao
{
    ...
    public class DataRepository
    {
        ...
        private DataContext context = new DataContext(new Uri("http://localhost:2769/BoringBank.svc/"));
        ...
        {
            return (from c in context.Clients where c.Name.ToLower().Contains(name.ToLower()) 
